...
/**
 * <p>ContractApproveInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ContractApproveInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ContractApproveInfo", propOrder = {
    "approveFlag",
    "clientNo",
    "contractID",
    "contractNo",
...
public class ContractApproveInfo {
    ...
    @XmlElementRef(name = "contractID", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
