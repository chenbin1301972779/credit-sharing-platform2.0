...
/**
 * <p>CrediteExchangeRate complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="CrediteExchangeRate"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="rateDate" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CrediteExchangeRate", propOrder = {
    "exchangerate",
    "item1",
    "item2",
    "item3",
...
public class CrediteExchangeRate {

    @XmlElementRef(name = "exchangerate", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> exchangerate;
    ...
    @XmlElementRef(name = "rateDate", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<Double> getExchangerate() {
        return exchangerate;
    }
     ...
     *     
     */
    public void setExchangerate(JAXBElement<Double> value) {
