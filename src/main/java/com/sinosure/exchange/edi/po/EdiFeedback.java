...
/**
 * <p>EdiFeedback complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="EdiFeedback"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="otherMsg" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "EdiFeedback", propOrder = {
    "clientNo",
    "corpSerialNo",
    "otherMsg",
    "returnCode",
...
public class EdiFeedback {
    ...
    @XmlElementRef(name = "otherMsg", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> otherMsg;
     ...
     *     
     */
    public JAXBElement<String> getOtherMsg() {
        return otherMsg;
    }
     ...
     *     
     */
    public void setOtherMsg(JAXBElement<String> value) {
        this.otherMsg = value;
    }
