...
/**
 * <p>ShipmentAlterApproveInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ShipmentAlterApproveInfo"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="approveFlag" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/&gt;
 *         &lt;element name="balanceShipmentID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="newShipmentID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "ShipmentAlterApproveInfo", propOrder = {
    "approveFlag",
    "balanceShipmentID",
    "clientNo",
    "corpAlterSerialNo",
...
public class ShipmentAlterApproveInfo {
    ...
    @XmlElementRef(name = "balanceShipmentID", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> balanceShipmentID;
    ...
    @XmlElementRef(name = "newShipmentID", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> newShipmentID;
     ...
     *     
     */
    public JAXBElement<String> getBalanceShipmentID() {
        return balanceShipmentID;
    }

    /**
     * 设置balanceShipmentID属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setBalanceShipmentID(JAXBElement<String> value) {
        this.balanceShipmentID = value;
    }
     ...
     *     
     */
    public JAXBElement<String> getNewShipmentID() {
     ...
     *     
     */
    public void setNewShipmentID(JAXBElement<String> value) {
        this.newShipmentID = value;
    }
