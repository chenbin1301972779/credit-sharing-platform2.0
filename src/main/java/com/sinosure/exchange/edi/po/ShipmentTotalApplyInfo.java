...
/**
 * <p>ShipmentTotalApplyInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ShipmentTotalApplyInfo"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="code8" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 ...
 *         &lt;element name="ifAddOA" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "ShipmentTotalApplyInfo", propOrder = {
    "applicantName",
    "applyTime",
    "bankAddr",
    "bankChnName",
...
public class ShipmentTotalApplyInfo {
    ...
    @XmlElementRef(name = "code8", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> code8;
    ...
    @XmlElementRef(name = "expectdate", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> expectdate;
    ...
    @XmlElementRef(name = "ifAddOA", namespace = "http://po.edi.exchange.sinosure.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ifAddOA;
     ...
     *     
     */
    public JAXBElement<String> getCode8() {
        return code8;
    }
     ...
     *     
     */
    public void setCode8(JAXBElement<String> value) {
        this.code8 = value;
    }
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getExpectdate() {
        return expectdate;
    }
     ...
     *     
     */
    public void setExpectdate(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<String> getIfAddOA() {
        return ifAddOA;
    }
     ...
     *     
     */
    public void setIfAddOA(JAXBElement<String> value) {
        this.ifAddOA = value;
    }
